...
[Script]
中通快递签到获取Token = type=http-request,pattern=https:\/\/membergateway\.zto\.com\/.*,requires-body=1,max-size=0,binary-body-mode=0,timeout=30,script-path=https://raw.githubusercontent.com/jy0703/scripts/main/scripts/zt_sign.js,script-update-interval=0
...
[Script]
http-request https:\/\/membergateway\.zto\.com\/.* tag=中通快递签到获取Token,script-path=https://raw.githubusercontent.com/jy0703/scripts/main/scripts/zt_sign.js,requires-body=1
...
[rewrite_local]
https:\/\/membergateway\.zto\.com\/.* url script-request-header https://raw.githubusercontent.com/jy0703/scripts/main/scripts/zt_sign.js
...
http:
  ...
  script:
    - match: https:\/\/membergateway\.zto\.com\/.*
      name: 中通快递签到获取Token
      type: request
      require-body: true
